...
public class VistaClasificacionEspec extends javax.swing.JFrame {

    private ControladorPartido controlador;

    public VistaClasificacionEspec() {
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> new VistaClasificacionEspec().setVisible(true));
    }
